...
class Workout {
  ...
  constructor(coords, distance, duration) {
    ...
    // this._setDescription(); not here but in child as type is there
  }
...
class Cycling extends Workout {
  ...
  calcSpeed() {
    //km/hr
    this.speed = this.distance / (this.duration / 66);
    return this.speed;
  }
}
...
class App {
  ...
  _newWorkout(e) {
    ...
    //If workout is cyclibg create cyclibg obj
    if (type === "cycling") {
